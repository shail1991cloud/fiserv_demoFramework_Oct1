...
Feature:Creation of Projects and validation of Project Setting Pop Up
  ...
  @Smoke @Reg @Positive @CRP-Test3 @TC7
  ...
  @Smoke @Reg @Positive @CRP-Test4 @TC8
  ...
  @Smoke @Reg @Positive @CRP-Test5 @TC9
  ...
  @Smoke @Reg @Positive @CRP-Test7 @TC11
  ...
  @Smoke @Reg @Negative @CRP-Test9 @TC13
  ...
  @Smoke @Reg @Negative @CRP-Test10 @TC14
